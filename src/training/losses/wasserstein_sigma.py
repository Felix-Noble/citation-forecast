...
@loss_registry('WassersteinSigmaLoss')
class WassersteinSigmaLoss:
    def __init__(
            self,
    ...
    def __call__(
        ...
        **kwargs
        ...
        ## Args: 
            ...
            beta: proportional importance of wasserstein > sigma (expected at config.train.loss.beta)
        ## Out:
            loss: wassterstein + sigma loss
       """ 
